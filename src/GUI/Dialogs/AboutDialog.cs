...
namespace NClass.GUI.Dialogs
{
  public partial class AboutDialog : Form
  {
    ...
    private void UpdateTexts()
    {
      ...
      lblCopyright.Text = $"Copyright (C) 2006-2009 {Strings.Author}{Environment.NewLine}Copyright (C) 2019-2020 {Strings.Author2}";
      ...
      lnkEmail.Links.Add(0, lnkEmail.Text.Length, "mailto:" + Properties.Resources.MailAddress + "?subject=NClass");
